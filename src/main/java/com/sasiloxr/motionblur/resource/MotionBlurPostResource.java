...
public class MotionBlurPostResource implements IResource {
  private static final String JSON =
      "{\"targets\":[\"swap\",\"previous\"],\"passes\":[{\"name\":\"motionblur\",\"intarget\":\"minecraft:main\",\"outtarget\":\"swap\",\"auxtargets\":[{\"name\":\"PrevSampler\",\"id\":\"previous\"}],\"uniforms\":[{\"name\":\"Phosphor\",\"values\":[%.2f,"
          + " %.2f,"
          + " %.2f]}]},{\"name\":\"blit\",\"intarget\":\"swap\",\"outtarget\":\"previous\"},{\"name\":\"blit\",\"intarget\":\"swap\",\"outtarget\":\"minecraft:main\"}]}";
  ...
  public InputStream getInputStream() {
    ...
    if (isNew) {
      return IOUtils.toInputStream(
          String.format(Locale.ENGLISH, JSON, 1 - blurMount / 10, 0.0, 0.0));
    } else {
